...
export function parseDate(val: any): Date | null {
    ...
    if (typeof val === 'number') {
        // Excel base date is Jan 1, 1900 (but Excel incorrectly treats 1900 as a leap year)
    ...
    if (dmyShortMatch) {
        ...
        return new Date(fullYear, parseInt(dmyShortMatch[2]) - 1, parseInt(dmyShortMatch[1]));
    }
