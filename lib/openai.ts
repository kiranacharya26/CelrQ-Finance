...
export async function categorizeTransactions(rawInput: string | any[], learnedKeywords: Record<string, string[]> = {}) {
    ...
    const keywordMap: Record<string, string[]> = {
        Healthcare: ['medic', 'pharma', 'hospital', 'clinic', 'doctor', 'apollo', '1mg', 'practo', 'diagnostic', 'health', 'cure', 'dr.', 'pharmacy', 'lifecare', 'medplus', 'lab'],
        Groceries: ['grocery', 'supermarket', 'zepto', 'blinkit', 'bigbasket', 'dmart', 'reliance fresh', 'more', 'jiomart', 'dunzo', 'vegetable', 'fruits', 'veggie', 'hopcoms', 'instamart', 'swiggy instamart', 'ratnadeep', 'star bazaar', 'nature basket'],
        "Restaurants & Dining": [
            'restaurant', 'zomato', 'swiggy', 'cafe', 'domino', 'pizza', 'burger', 'kfc', 'mcdonald', 'starbucks', 'coffee', 'tea', 'bar', 'dining', 'dhaba', 'biryani', 'mess', 'canteen', 'tiffin', 'eatery', 'dine', 'food',
            'bhavan', 'sagar', 'dwaraka', 'grand', 'kitchen', 'hotel', 'udupi', 'a2b', 'saravana', 'haldiram', 'chai', 'sweets', 'bakers', 'bakery', 'roastery', 'bistro'
        ],
        Fuel: ['fuel', 'petrol', 'diesel', 'hpcl', 'bpcl', 'ioc', 'shell', 'gas station', 'bharat petroleum', 'indian oil', 'filling station'],
        "Ride Services": ['uber', 'ola', 'rapido', 'auto', 'cab', 'taxi', 'namma yatri', 'rideshare', 'uber india', 'olacabs'],
        "Travel & Transport": ['redbus', 'makemytrip', 'goibibo', 'yatra', 'cleartrip', 'ixigo', 'abhibus', 'bus ticket', 'flight', 'hotel booking', 'travel', 'booking', 'trip', 'holiday', 'vacation', 'airbnb', 'oyo', 'treebo', 'indigo', 'air india', 'vistara', 'irctc', 'car service', 'garage', 'auto works', 'service station', 'mechanic', 'tyre', 'honda', 'toyota', 'hyundai', 'maruti', 'tata motors'],
        "Public Transport": ['metro', 'bus', 'rail', 'irctc', 'train', 'fastag', 'toll', 'bmtc', 'ksrtc', 'railway', 'ticket', 'transport'],
        "Utilities": ['electricity', 'water', 'gas cylinder', 'bescom', 'bwssb', 'electricity bill', 'water bill', 'lpg', 'indane', 'utility', 'billdesk', 'bbmp'],
        "Credit Card Payments": ['cred', 'credit card', 'cc payment', 'card payment', 'cheq', 'sbicard', 'hdfc credit', 'axis credit', 'amex'],
        ...
        "Online Shopping": ['amazon', 'flipkart', 'myntra', 'meesho', 'ajio', 'nykaa', 'amazon.in', 'shopping', 'ecommerce', 'tatacliq', 'snapdeal'],
        "Retail & Stores": ['mall', 'decathlon', 'ikea', 'croma', 'reliance', 'trends', 'zudio', 'h&m', 'zara', 'uniqlo', 'lifestyle', 'store', 'retail', 'clothing', 'fashion', 'pantaloons', 'westside', 'titan', 'lenskart'],
        "Streaming Services": ['netflix', 'prime', 'hotstar', 'spotify', 'youtube', 'google youtube', 'disney', 'subscription', 'streaming', 'apple music', 'gaana', 'jiosaavn', 'sonyliv', 'zee5', 'hulu', 'hbo'],
        "Events & Recreation": ['movie', 'theatre', 'bookmyshow', 'pvr', 'inox', 'game', 'steam', 'playstation', 'concert', 'event', 'cinema', 'entertainment', 'wonderla', 'amusement'],
        Housing: ['rent', 'rental', 'lease', 'landlord', 'tenant', 'maintenance', 'society', 'housing', 'apartment', 'flat', 'nobroker', 'nestaway', 'deposit', 'advance', 'radhakrishna k l', 'klradhakrishna', 'maintenance bill'],
        Education: ['school', 'college', 'course', 'tuition', 'education', 'book', 'udemy', 'coursera', 'skillshare', 'learning', 'academy', 'study', 'university', 'fee'],
        Income: ['salary', 'credit', 'refund', 'cashback', 'payment received', 'interest', 'dividend', 'reversal', 'income', 'neft', 'imps', 'rtgs'],
        Insurance: ['insurance', 'policy', 'lic', 'acko', 'digit', 'star health', 'hdfc ergo', 'premium', 'max life', 'sbi life'],
        Investments: ['mutual fund', 'sip', 'stock', 'investment', 'zerodha', 'groww', 'upstox', 'coin', 'smallcase', 'equity', 'shares', 'angel one', 'kuvera'],
        "Personal Care": ['salon', 'spa', 'gym', 'fitness', 'cult', 'urban company', 'hair', 'beauty', 'parlour', 'grooming', 'barber', 'skin', 'clinic']
    };
...
7. **Vehicle & Medical Inference**:
   - "Car Service", "Garage", "Auto Works", "Service Station", "Mechanic" -> **Travel & Transport** (or Personal Care if applicable, but prefer Transport).
   - "Medical", "Pharmacy", "Lifecare", "Clinic", "Hospital", "Lab" -> **Healthcare**.
   - **NEVER** categorize these as "Credit Card Payments" even if paid via UPI.

8. **Credit Card Payment Rules (STRICT)**:
   - ONLY categorize as "Credit Card Payments" if it is a BILL PAYMENT for a credit card (e.g., "CRED", "SBI CARD BILL", "HDFC CC PAYMENT").
   - Regular purchases made using a credit card or UPI are NOT "Credit Card Payments" - categorize them by what was bought (e.g., "Medical", "Groceries").

9. **Extract keywords** - Identify the main merchant/brand name (lowercase, no spaces)

10. **Only use "Other"** if you genuinely cannot identify the merchant after reading the entire description
...
- "UPI-NEW LIFECARE MEDICAL" → Category: "Healthcare", Keyword: "new lifecare medical"
- "EXPERT CAR SERVICE" → Category: "Travel & Transport", Keyword: "expert car service"
